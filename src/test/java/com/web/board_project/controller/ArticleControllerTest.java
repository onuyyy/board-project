...
//
//
//import com.web.board_project.config.TestSecurityConfig;
//import com.web.board_project.domain.constant.FormStatus;
...
//import com.web.board_project.dto.request.ArticleRequest;
//import com.web.board_project.dto.response.ArticleResponse;
...
//    }
//
//    @WithMockUser // User 정보를 목킹해서 넣어줌 단, UserDetailService를 타지 않아서 실제로 사용하는 사용자인지는 확인 불가능
...
//    @Test
//    public void givenHashtag_whenRequestingArticleHashtagSearchingView_thenReturnArticleHashtagSearchingView() throws Exception {
//        // given
//        String hashtag ="#java";
//        List<String> hashtags = List.of("#java", "#spring", "#boot");
...
//    }
//
//    @WithUserDetails(value = "testId", userDetailsServiceBeanName = "userDetailsService", setupBefore = TestExecutionEvent.TEST_EXECUTION)
